...
RUN bash /TCHA/miniconda/Miniconda3-py38_4.12.0-Linux-x86_64.sh -b -p /opt/miniconda 

RUN . /opt/miniconda/bin/activate && conda env update --name base --file /TCHA/tcrm_from_history.yml 
